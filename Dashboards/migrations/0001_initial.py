    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('production_line', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Dashboards.productionline', verbose_name='Производственная линия')),
            ],
        ),
        migrations.CreateModel(
            name='BrewingEvent',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, verbose_name='Описание')),
                ('equipment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Dashboards.equipment', verbose_name='Оборудование')),
            ],
        ),
    ]
